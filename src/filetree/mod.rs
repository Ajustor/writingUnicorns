...
impl FileEntry {
    pub fn new(path: PathBuf, depth: usize) -> Self {
        ...
        Self { name, path, is_dir, is_expanded: depth == 0, children: vec![], depth }
    }
    ...
    fn show_entry_recursive(
        ...
        ui.horizontal(|ui| {
            ...
            if entry.is_dir {
                ...
                let label = egui::RichText::new(format!("{} {} {}", arrow, folder_icon, entry.name))
                    .color(color);
                ...
                let label = egui::RichText::new(format!("{} {}", icon, entry.name))
